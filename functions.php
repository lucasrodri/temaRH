...
/**
 * Shortcode das redes, criados com função anônima - Modificado para o RGP
 */

add_shortcode('shortcode_criancas', function () {
	gerar_redes_principal('criancas', 'criancas_categoria');
});

function chama_shortcode_redes($params) {
	$var = shortcode_atts([
			'rede_slug' => 'rede-0',
			'categoria_slug' => 'rede-0-categoria',
	], $params);
